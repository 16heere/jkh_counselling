    ...
    return (
        ...
        >
            <defs>
                <clipPath id="hc">
                    <path
                        d="M 189.59375 0 C 87.199219 0 4.191406 83.007812 4.191406 185.40625 C 4.191406 287.800781 87.199219 370.808594 189.59375 370.808594 C 291.992188 370.808594 375 287.800781 375 185.40625 C 375 83.007812 291.992188 0 189.59375 0 Z"
                        clipRule="nonzero"
                    />
                </clipPath>
                <clipPath id="hd">
                    <path
                        d="M 21 215 L 194 42 L 359 207 L 185 380 Z"
                        clipRule="nonzero"
                    />
                </clipPath>
            </defs>
            <g clipPath="url(#hc)">
                <path
                    fill="#a4ebf3"
                    fillOpacity="0.15"
                    d="M 4 0 L 375 0 L 375 371 L 4 371 Z"
                />
            </g>
            <g clipPath="url(#hd)">
                <path
